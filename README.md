...
`Java` `Spring Boot` `React` `MySQL` `REST API` `Postman`

---

### 💼 Online Job & Internship Portal

A team-based **Java Full Stack Development** project developed during my internship.
...
🏗️ **Smart India Hackathon 2025 — Participant**

---

## 🧩 Problem Solving

I practice **Data Structures & Algorithms daily** to improve my logical thinking, coding ability, and problem-solving skills.

I regularly solve problems on **LeetCode** and focus on understanding the logic, approach, and optimization behind each problem.
...
> **To become a skilled Java Full Stack Developer and build reliable, scalable, and practical software solutions that solve real-world problems.**

I believe in **learning by building**. I continuously work on projects, practice DSA daily, explore new technologies, and improve my development skills step by step.
